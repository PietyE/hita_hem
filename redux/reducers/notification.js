import {SET_NOTIFICATION_STATUS,SET_NOTIFICATION_MESSAGE,SET_NOTIFICATION_TITLE} from 'constants/actionsConstant';
...
export const getNotificationStatusSelector = state => state.notification.showNotification
export const getNotificationMessageSelector = state => state.notification.message
