...
export const getRaiseFirstNameErrorSelector = state => state.errors?.raise?.first_name
export const getRaiseSecondNameErrorSelector = state => state.errors?.raise?.second_name
...
export const getRaiseCompanyNameSelector = state => state.errors?.raise?.company_name
export const getRaiseCompanyFormSelector = state => state.errors?.raise?.company_form
export const getRaiseRoleSelector = state => state.errors?.raise?.role
export const getRaiseSharePriceSelector = state => state.errors?.raise?.share_price
...
export const getRaiseVideoPreviewSelector = state => state.errors?.raise?.video_preview
export const getRaiseSocialsOneSelector = state => state.errors?.raise?.social_one
export const getRaiseSocialsTwoSelector = state => state.errors?.raise?.social_two
export const getRaiseSocialsThreeSelector = state => state.errors?.raise?.social_three
export const getRaiseFollowersOneSelector = state => state.errors?.raise?.followers_count_one
export const getRaiseFollowersTwoSelector = state => state.errors?.raise?.followers_count_two
export const getRaiseFollowersThreeSelector = state => state.errors?.raise?.followers_count_three
export const getRaiseFormDocumentsErrorSelector = state => isEmpty(state.errors?.raise?.documents)
export const getFirstNameErrorSelector = state => state.errors?.profile?.first_name
export const getSecondNameErrorSelector = state => state.errors?.profile?.second_name
export const getDateOfBirthErrorSelector = state => state.errors?.profile?.date_of_birth
export const getCountryErrorSelector = state => state.errors?.profile?.address?.country
export const getCityErrorSelector = state => state.errors?.profile?.address?.city
export const getAddressErrorSelector = state => state.errors?.profile?.address?.address
export const getPersonalIdErrorSelector = state => state.errors?.profile?.personal_id
export const getPhoneErrorSelector = state => state.errors?.profile?.companies
export const getAuthEmailErrorSelector = state => state.errors?.auth?.email
export const getAuthPasswordErrorSelector = state => state.errors?.auth?.password
export const getAuthOldPasswordErrorSelector = state => state.errors?.auth?.old_password?.user || state.errors?.auth?.old_password
export const getAuthNewPassword1ErrorSelector = state => state.errors?.auth?.new_password1
export const getAuthNewPassword2ErrorSelector = state => state.errors?.auth?.new_password2
...
export const errors = (state = initialState, actions) => {
  switch (actions.type) {
    ...
    case ERROR:
      return {...state, status: actions.payload.status, data: actions.payload.data}
    case SET_RAISE_ERROR:
      return {...state, status: actions.payload.status, raise: actions.payload.data}
    case SET_PROFILE_ERROR:
      return {...state, status: actions.payload.status, profile: actions.payload.data}
    case SET_AUTH_ERROR:
      return {...state, status: actions.payload.status, auth: actions.payload.data}
    ...
    case SET_PROFILE_COUNTRY_ERROR:
      return {...state, profile: {...state.profile, address:{...state.profile.address, country: ''}}}
    case SET_PROFILE_CITY_ERROR:
      return {...state, profile: {...state.profile, address:{...state.profile.address, city: ''}}}
    case SET_PROFILE_ADDRESS_ERROR:
      return {...state, profile: {...state.profile, address:{...state.profile.address, address: ''}}}
