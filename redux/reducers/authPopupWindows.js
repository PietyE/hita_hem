...
export const getShowResetPassword = (state) => state.authPopupWindows.showResetPassword;
export const getShowSuccessfulSignUp = (state) => state.authPopupWindows.showSuccessfulSignUp;
export const getShowSuccessfulCampaignRegistration = (state) => state.authPopupWindows.showSuccessfulCampaignRegistration;
export const getShowSuccessfulInvestment = (state) => state.authPopupWindows.showSuccessfulInvestment;
export const getShowSuccessfulResetPassword = (state) => state.authPopupWindows.showSuccessfulResetPassword;
export const getShowSuccessfulDeletedAccount = state =>  state.authPopupWindows.showSuccessfulDeletedAccount;
export const getShowConfirmationOfAccountDeleting = state =>  state.authPopupWindows.showConfirmationOfAccountDeleting;
