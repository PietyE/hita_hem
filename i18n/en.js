export const en = {
    translation: {
        ...
        raisePage: {
            ...
            raise_form_text: 'Wed like to hear more from you. Just 4 steps and our team will make a preliminary evaluation.',
            form1: {
        ...
        auth: {
            resetPasswordPopup: {
                ...
                description: 'Please enter your email and we’ll send you instructions to reset your password',
                label: 'Email Address *',
        ...
        successful_campaign_registration:{
            title:'Congratulations on completing your first step towards launching your campaign!',
        ...
        invest_form_page:{
            main_text: 'Before start investing please fill the form including all the necessary information',
            progress_rise:'Raised',
            progress_target:'Target',
            invest_title: 'Amount you wish to invest',
            invest_text: 'Please be informed that the minimum amount you can invest is',
            invest_label: 'Amount to invest*',
            invest_placeholder: 'For example',
            statistics_title: 'Your Investment',
            statistics_shares: 'shares',
            statistics_text: 'Please keep in mind that your investment could be rounded down to the nearest whole share',
