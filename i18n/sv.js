export const sv = {
    translation: {
        ...
        raisePage: {
            ...
            raise_form_text: 'Vi behöver mer information från dig. Fyll i 4 korta steg och vi återkommer med ett preliminärt besked',
        ...
        auth: {
            resetPasswordPopup: {
                ...
                description: 'Var vänlig att ange din mailadress och vi skicka instruktioner för att återställa ditt lösenord',
                label: 'Mailadress *',
        ...
        about_us_page: {
            subscribe_title: 'Ligg steget före genom att prenumerera på vårt nyhetsbrev',
            placeholder: 'Ange din mailadress',
            button: 'Prenumerera',
        ...
        invest_form_page: {
            main_text: 'Innan du börjar investera måste du fylla in informationen ned',
            ...
            statistics_text: 'Din investering kommer avrundas ner till närmaste aktier antal',
