                            ...
                            <Accordion.Collapse eventKey = {index + 1}>
                                <Card.Body className = 'mobile_investments_item'>
                                    <p className = 'mobile_investments_field mobile_investments_item_link'>
                                        <span className = 'mobile_investments_field_text'>{t('profile_page.investments.link')}</span>
                                    ...
                                    <p className = 'mobile_investments_field mobile_investments_amount'>
                                        <span className = 'mobile_investments_field_text'>{t('profile_page.investments.amount')}</span>
                                        <span className = 'mobile_investments_field_values'>{payment.amount_currency}{' '}{payment.amount}</span>
                                    </p>
                                    <p className = 'mobile_investments_field mobile_investments_shares'>
                                        <span className = 'mobile_investments_field_text'>{t('profile_page.investments.shares')}</span>
                                        <span className = 'mobile_investments_field_values'>{payment.shares}</span>
                                    </p>
                                    <div className = 'mobile_investments_field mobile_investments_contact'>
                                        <a href = {'mailto:' + payment.owner_email}>
                                            <Button colorStyle = 'dark-green'
                                                    className = 'mobile_investments_item_button'>{t('profile_page.investments.button')}</Button>
                                        </a>
