...
const AccountSettings = () => {
    ...
    return (
        <section className = 'account_settings_container'>
            <h2 className = 'account_settings_title'>{t('profile_page.account.title')}</h2>
            <div className = 'account_settings_form'>
                <ResetEmail/>
                <AccountSettingsResetPassword/>
                <p className = 'account_settings_text_delete' onClick={handleClickDelete}>{t('profile_page.account.text_delete')}</p>
                <p className = 'account_settings_text'>{t('profile_page.account.text')}</p>
            </div>
        </section>
    );
}
