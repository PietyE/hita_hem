                        ...
                        <Card key = {index} className = 'mobile_investments_card'>
                            <Accordion.Toggle
                                ...
                                <span className = "tab_accordion_chevron">
                                    <FontAwesomeIcon
                                        icon = {Number(activeTab) === index + 1 ? faChevronDown : faChevronRight}/>
                                </span>
                            </Accordion.Toggle>
                            <Accordion.Collapse eventKey = {index + 1}>
                                <Card.Body className = 'mobile_investments_item'>
                                    <p className = 'mobile_investments_field mobile_investments_item_link'>
                                        <span className = 'mobile_investments_field_text'>{t('profile_page.campaigns.link')}</span>
                                        <a href = {_link} className = 'mobile_investments_field_link'>{_link}</a>
                                    </p>
                                    <p className = 'mobile_investments_field mobile_investments_amount'>
                                        <span className = 'mobile_investments_field_text'>{t('profile_page.campaigns.start_date')}</span>
                                        <span className = 'mobile_investments_field_values'>{_startDayLocal}</span>
                                    </p>
                                    <p className = 'mobile_investments_field mobile_investments_shares'>
                                        <span className = 'mobile_investments_field_text'>{t('profile_page.campaigns.end_date')}</span>
                                        <span className = 'mobile_investments_field_values'>{_endDayLocal}</span>
                                    </p>
                                    <p className = 'mobile_investments_field mobile_investments_shares'>
                                        <span className = 'mobile_investments_field_text'>{t('profile_page.campaigns.status')}</span>
                                        <span className = 'mobile_investments_field_values'>{_status}</span>
                                    </p><p className = 'mobile_investments_field mobile_investments_shares'>
                                    <span className = 'mobile_investments_field_text'>{t('profile_page.campaigns.raised')}</span>
                                    <span className = 'mobile_investments_field_values'>{campaign.goal_currency}{' '}{campaign.goal}</span>
                                </p>
                                </Card.Body>
                            </Accordion.Collapse>
                        </Card>
